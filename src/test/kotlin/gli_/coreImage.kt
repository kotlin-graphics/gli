...
class coreImage : StringSpec() {
    ...
    init {
        ...
        "fetch" {
            ...
            image.data<Vec4b>()[0] = Vec4b(255, 0, 0, 255)
            image.data<Vec4b>()[1] = Vec4b(255, 128, 0, 255)
            image.data<Vec4b>()[2] = Vec4b(255, 255, 0, 255)
            image.data<Vec4b>()[3] = Vec4b(128, 255, 0, 255)
            image.data<Vec4b>()[4] = Vec4b(0, 255, 0, 255)
            image.data<Vec4b>()[5] = Vec4b(0, 255, 255, 255)
