...
class GL(val profile: Profile) {
    ...
    init {
        ...
        if (tableF.size != FORMAT_COUNT) throw Error("GLI error: format descriptor list doesn't match number of supported formats")
    }
    ...
    fun translate(format: gli.Format, swizzles: gli.Swizzles): Format {
        ...
        if (format !in FORMAT_FIRST..FORMAT_LAST) throw Error()
    ...
    private fun computeSwizzle(formatDesc: FormatDesc, swizzles: gli.Swizzles): Swizzles {
    ...
    enum class InternalFormat(@JvmField val i: Int) {
    ...
    enum class ExternalFormat(@JvmField val i: Int) {
    ...
    enum class TypeFormat(@JvmField val i: Int) {
    ...
    enum class Target(@JvmField val i: Int) {
    ...
    enum class Swizzle(@JvmField val i: Int) {
