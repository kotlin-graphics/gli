...
object dx {
    ...
    fun find(fourCC: D3dfmt) = gli.Format.of((FORMAT_FIRST.i..FORMAT_LAST.i)
    ...
    fun find(fourCC: D3dfmt, format: DxgiFormat): gli.Format {
        ...
        return gli.Format.of(result)
    }

    fun isDdsExt(target: Target, format: gli.Format): Boolean {
    ...
    private val table by lazy {
        val table = arrayOf(
                ...
                Format(RGBA, A8R8G8B8, B8G8R8A8_UNORM, Vec4i(0x00FF0000, 0x0000FF00, 0x000000FF, 0xFF000000)), //FORMAT_BGRA8_UNORM,
