...
object gl {
    ...
    fun find(internalFormat: InternalFormat, externalFormat: ExternalFormat, type: TypeFormat): gli.Format {
        ...
        val format = tableF.find { it.internal == internalFormat && it.external == externalFormat && it.type == type }
        return if (format == null) gli.Format.INVALID
        else gli.Format.of(tableF.indexOf(format) + 1) // +1 to offset UNDEFINED
    }
