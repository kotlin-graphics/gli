...
object detail {
    ...
    internal val tableFormatInfos: Array<FormatInfo> by lazy {
        arrayOf(
                ...
                FormatInfo(2, Vec3i(1, 1, 1), 3, Swizzles(RED, GREEN, BLUE, ONE), PACKED16_BIT or NORMALIZED_BIT or UNSIGNED_BIT or DDS_GLI_EXT_BIT),            //FORMAT_R5G6B5_UNORM,
                FormatInfo(2, Vec3i(1, 1, 1), 3, Swizzles(BLUE, GREEN, RED, ONE), PACKED16_BIT or NORMALIZED_BIT or UNSIGNED_BIT),                                    //FORMAT_B5G6R5_UNORM,
                FormatInfo(2, Vec3i(1, 1, 1), 4, Swizzles(RED, GREEN, BLUE, ALPHA), PACKED16_BIT or NORMALIZED_BIT or UNSIGNED_BIT or DDS_GLI_EXT_BIT),            //FORMAT_RGB5A1_UNORM,
                FormatInfo(2, Vec3i(1, 1, 1), 4, Swizzles(BLUE, GREEN, RED, ALPHA), PACKED16_BIT or NORMALIZED_BIT or UNSIGNED_BIT),                                //FORMAT_BGR5A1_UNORM,
                FormatInfo(2, Vec3i(1, 1, 1), 4, Swizzles(ALPHA, RED, GREEN, BLUE), PACKED16_BIT or NORMALIZED_BIT or UNSIGNED_BIT or DDS_GLI_EXT_BIT),            //FORMAT_A1RGB5_UNORM,
                ...
                FormatInfo(1, Vec3i(1, 1, 1), 1, Swizzles(RED, ZERO, ZERO, ONE), SCALED_BIT or UNSIGNED_BIT or DDS_GLI_EXT_BIT),                                    //FORMAT_R8_USCALED,
                FormatInfo(1, Vec3i(1, 1, 1), 1, Swizzles(RED, ZERO, ZERO, ONE), SCALED_BIT or SIGNED_BIT or DDS_GLI_EXT_BIT),                                        //FORMAT_R8_SSCALED,
                ...
                FormatInfo(2, Vec3i(1, 1, 1), 2, Swizzles(RED, GREEN, ZERO, ONE), SCALED_BIT or UNSIGNED_BIT or DDS_GLI_EXT_BIT),                                    //FORMAT_RG8_USCALED,
                FormatInfo(2, Vec3i(1, 1, 1), 2, Swizzles(RED, GREEN, ZERO, ONE), SCALED_BIT or SIGNED_BIT or DDS_GLI_EXT_BIT),                                        //FORMAT_RG8_SSCALED,
                ...
                FormatInfo(3, Vec3i(1, 1, 1), 3, Swizzles(RED, GREEN, BLUE, ONE), SCALED_BIT or UNSIGNED_BIT or DDS_GLI_EXT_BIT),                                    //FORMAT_RGB8_USCALED,
                FormatInfo(3, Vec3i(1, 1, 1), 3, Swizzles(RED, GREEN, BLUE, ONE), SCALED_BIT or SIGNED_BIT or DDS_GLI_EXT_BIT),                                        //FORMAT_RGB8_SSCALED,
                ...
                FormatInfo(3, Vec3i(1, 1, 1), 3, Swizzles(BLUE, GREEN, RED, ONE), SCALED_BIT or UNSIGNED_BIT or SWIZZLE_BIT or DDS_GLI_EXT_BIT),                                    //FORMAT_BGR8_USCALED,
                FormatInfo(3, Vec3i(1, 1, 1), 3, Swizzles(BLUE, GREEN, RED, ONE), SCALED_BIT or SIGNED_BIT or SWIZZLE_BIT or DDS_GLI_EXT_BIT),                                    //FORMAT_BGR8_SSCALED,
                ...
                FormatInfo(4, Vec3i(1, 1, 1), 4, Swizzles(RED, GREEN, BLUE, ALPHA), SCALED_BIT or UNSIGNED_BIT or DDS_GLI_EXT_BIT),                                    //FORMAT_RGBA8_USCALED,
                FormatInfo(4, Vec3i(1, 1, 1), 4, Swizzles(RED, GREEN, BLUE, ALPHA), SCALED_BIT or SIGNED_BIT or DDS_GLI_EXT_BIT),                                    //FORMAT_RGBA8_SSCALED,
                ...
                FormatInfo(4, Vec3i(1, 1, 1), 4, Swizzles(BLUE, GREEN, RED, ALPHA), SCALED_BIT or UNSIGNED_BIT or SWIZZLE_BIT or DDS_GLI_EXT_BIT),                //FORMAT_BGRA8_USCALED,
                FormatInfo(4, Vec3i(1, 1, 1), 4, Swizzles(BLUE, GREEN, RED, ALPHA), SCALED_BIT or SIGNED_BIT or SWIZZLE_BIT or DDS_GLI_EXT_BIT),                    //FORMAT_BGRA8_SSCALED,
                ...
                FormatInfo(4, Vec3i(1, 1, 1), 4, Swizzles(BLUE, GREEN, RED, ALPHA), SCALED_BIT or UNSIGNED_BIT or SWIZZLE_BIT or PACKED32_BIT or DDS_GLI_EXT_BIT),        //FORMAT_RGBA8_USCALED_PACK32,
                FormatInfo(4, Vec3i(1, 1, 1), 4, Swizzles(BLUE, GREEN, RED, ALPHA), SCALED_BIT or SIGNED_BIT or SWIZZLE_BIT or PACKED32_BIT or DDS_GLI_EXT_BIT),            //FORMAT_RGBA8_SSCALED_PACK32,
                ...
                FormatInfo(4, Vec3i(1, 1, 1), 4, Swizzles(RED, GREEN, BLUE, ALPHA), SCALED_BIT or UNSIGNED_BIT or PACKED32_BIT or DDS_GLI_EXT_BIT),                        //FORMAT_RGB10A2_USCALE,
                FormatInfo(4, Vec3i(1, 1, 1), 4, Swizzles(RED, GREEN, BLUE, ALPHA), SCALED_BIT or SIGNED_BIT or PACKED32_BIT or DDS_GLI_EXT_BIT),                        //FORMAT_RGB10A2_SSCALE,
                ...
                FormatInfo(4, Vec3i(1, 1, 1), 4, Swizzles(BLUE, GREEN, RED, ALPHA), SCALED_BIT or UNSIGNED_BIT or PACKED32_BIT or SWIZZLE_BIT or DDS_GLI_EXT_BIT),        //FORMAT_BGR10A2_USCALE,
                FormatInfo(4, Vec3i(1, 1, 1), 4, Swizzles(BLUE, GREEN, RED, ALPHA), SCALED_BIT or SIGNED_BIT or PACKED32_BIT or SWIZZLE_BIT or DDS_GLI_EXT_BIT),            //FORMAT_BGR10A2_SSCALE,
                ...
                FormatInfo(2, Vec3i(1, 1, 1), 1, Swizzles(RED, ZERO, ZERO, ONE), SCALED_BIT or UNSIGNED_BIT or DDS_GLI_EXT_BIT),                //FORMAT_R16_USCALE,
                FormatInfo(2, Vec3i(1, 1, 1), 1, Swizzles(RED, ZERO, ZERO, ONE), SCALED_BIT or SIGNED_BIT or DDS_GLI_EXT_BIT),                    //FORMAT_R16_SSCALE,
                ...
                FormatInfo(4, Vec3i(1, 1, 1), 2, Swizzles(RED, GREEN, ZERO, ONE), SCALED_BIT or UNSIGNED_BIT or DDS_GLI_EXT_BIT),                //FORMAT_RG16_USCALE,
                FormatInfo(4, Vec3i(1, 1, 1), 2, Swizzles(RED, GREEN, ZERO, ONE), SCALED_BIT or SIGNED_BIT or DDS_GLI_EXT_BIT),                    //FORMAT_RG16_SSCALE,
                ...
                FormatInfo(6, Vec3i(1, 1, 1), 3, Swizzles(RED, GREEN, BLUE, ONE), SCALED_BIT or UNSIGNED_BIT or DDS_GLI_EXT_BIT),            //FORMAT_RGB16_USCALE,
                FormatInfo(6, Vec3i(1, 1, 1), 3, Swizzles(RED, GREEN, BLUE, ONE), SCALED_BIT or SIGNED_BIT or DDS_GLI_EXT_BIT),            //FORMAT_RGB16_SSCALE,
                ...
                FormatInfo(8, Vec3i(1, 1, 1), 4, Swizzles(RED, GREEN, BLUE, ALPHA), SCALED_BIT or UNSIGNED_BIT or DDS_GLI_EXT_BIT),        //FORMAT_RGBA16_USCALE,
                FormatInfo(8, Vec3i(1, 1, 1), 4, Swizzles(RED, GREEN, BLUE, ALPHA), SCALED_BIT or SIGNED_BIT or DDS_GLI_EXT_BIT),            //FORMAT_RGBA16_SSCALE,
